...
using curso.api.Infra.Repositories;
...
namespace curso.api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //precisa-se adicionar essas configurações pois estão em projetos diferentes
            services.AddDbContext<CursoDbContext>(
                options =>
                options.UseSqlServer(Configuration.GetConnectionString("DefaultConnection"), //configurado no appsettings.json
                x => x.MigrationsAssembly("curso.api.Infra")));

            var key = Encoding.ASCII.GetBytes(Configuration.GetSection("JwtConfigurations:Secret").Value);
            //informa para a aplicação que trabalharemos com autorização e o formato do token é JWT
